...
Metriql doesn't have a user interface that lets you analyze it because it's [Headless BI](https://metriql.com/introduction/intro). However, it comes with a dashboard that enables you to use the integrations that we have. Here is how it looks like:

<img src="/img/blog/metriql-demo/dashboard1.png" alt="Metriql Dashboard" style={{width: '100% !important'}}/>
