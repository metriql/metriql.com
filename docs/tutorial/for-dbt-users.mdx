...
<TabItem value="local">
  All dbt projects are also valid metriql projects. metriql created [datasets](/creating-datasets) from all your `models`, `seeds`, and `sources`. The only missing 
</TabItem>
...
You can learn more about the data modeling concept in [Creating Datasets](/creating-datasets).