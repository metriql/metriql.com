...
metriql creates dimensions for each column definitions in your resource files but since dbt doesn't provide any way to define metrics, we make use of the `meta` property as follows:
