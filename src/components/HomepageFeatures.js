...
const FeatureList = [
  {
    ...
    description: (
      <>
        Metriql integrates with <a target="_blank" href="https://getdbt.com">dbt</a> and maps dbt resources as [datasets](/tutorial/for-dbt-users). It can also create automatic dbt roll-up models to save data teams' time.
      </>
    ),
  },
  {
