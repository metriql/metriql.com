    ...
    <Layout
      ...
      <main>
        ...
        <div className="container" style={{ textAlign: 'left', maxWidth: '950px'}}>
          ...
          <div style={{ textAlign: 'center', 'backgroundColor': '#FFF3CD', border-color: '#ffeeba', color: '#856404', }} className="admonition alerst alert--info"><div className="admonition-heading"><h6 style={{ 'marginBottom': '0' }}><span className="admonition-icon" >
