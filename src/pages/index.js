  ...
  return (
    <Layout
      ...
      <main>
        ...
        <div className="container" style={{ textAlign: 'left', width: '900px', margin: '0 auto' }}>

          <div style={{ 'backgroundColor': '#FFF3CD', color: 'black', border: 'none' }} className="admonition alerst alert--info"><div className="admonition-heading"><h6 style={{ 'marginBottom': '0' }}><span className="admonition-icon" >
        ...
        metriql is very much under <a href="https://github.com/metriql/metriql/issues">active development</a>. We'd certainly welcome any help, ideas or integration requests!
